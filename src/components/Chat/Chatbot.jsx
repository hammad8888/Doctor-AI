...
export default function Chatbot({ chatId, updateChatTitle }) {
  ...
  const generateAIResponse = (text, file) => {
    if (file) {
      return `I've received your ${file.type.startsWith('image/') ? 'image' : 'document'} about ${specialization}. How can I help you with it?`;
    }
    return `Regarding your question about ${specialization}: ${text}. Here's my professional advice...`;
  };
          ...
          {messages.length === 0 && (
            <div className="flex flex-col items-center justify-center h-full text-center py-12">
              ...
              <p className="text-gray-600 dark:text-gray-400 max-w-md">
                Ask me anything about {specialization.toLowerCase()} or describe your symptoms.
              </p>
            </div>
          )}
